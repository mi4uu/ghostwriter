...
ID_AUTHOR_Last_NAME="data-print-book-primary-author-last-name"
...
ID_SAVE_AND_CONTINUE_BTN="save-and-continue-announce"
DESCRIPTON_INPUT_NAME="data[print_book][description]"
# data
